...
namespace Todolist\TodoBundle\Controller;
...
use Todolist\TodoBundle\Entity\Todo;
use Todolist\TodoBundle\Form\TodoType;
...
class TodoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TodolistTodoBundle:Todo')->findByPT(new \DateTime());
     ...
     * @Method("POST")
     * @Template("TodolistTodoBundle:Todo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TodolistTodoBundle:Todo')->find($id);
